...
import com.lichanghai.edgelen.foundation.cluster.kmeans3.KMeansModel;
...
public class KmeansColorSeparator implements PixelSeparator {
    ...
    private void run() {
        ...
        KMeansModel[] models = new KMeans3(colors.toArray(new Point3[colors.size()])).cluster(2);

        //Point3[] means = new KMeans3(colors.toArray(new Point3[colors.size()])).cluster(2);
